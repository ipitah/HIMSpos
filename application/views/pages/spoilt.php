...
<table id="spoilt-table" class="table table-bordered table-striped table-hover">
<thead>
<tr><td>Item name</td><td>Description</td><td>Quantity</td><td>Date recorded</td><td>Staff</td><td>Update</td><td>Delete</td></tr>
</thead>
<tbody>
</tbody>
</table>
...
<button type="button" onclick="printJS('spoilt-table', 'html')" class='btn btn-small btn-success form-control'>
    Print items 
 </button>

...
<td>
        ...
        <label for="psupplier">Suppler ID NO./Passport</label>
...
<td>
       <input type="submit" value="Add 5 more Items"  name="addmore" id="addmore" class='btn btn-large btn-info form-control'  />
</td>
...
<td>
        <input type="submit" value="Submit"  name="submit" id="submit"  class='btn btn-large btn-success form-control'  />
</td>
</tr>

...
echo form_open('updatecategory', $attributes); ?>
...
<p>
        ...
        <br /><input id="category" type="text" name="category" class="form-control" maxlength="50" value="<?php  if(isset($id)) echo $cat; else echo set_value('category'); ?>"  />
</p>

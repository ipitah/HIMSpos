...
echo form_open('update_item', $attributes); ?>
...
<p>
        ...
        <input id="itemname" type="text" name="itemname"  value="<?php if(isset($id)) echo $customer[0]['itemname']; else echo set_value('itemname'); ?>"  />
</p>
...
<p>
	...
	<?php if(isset($id))
	echo form_textarea( array( 'name' => 'itemdesc', 'rows' => '5', 'cols' => '80', 'value' => $customer[0]['itemdesc'] ) );
	else
	 echo form_textarea( array( 'name' => 'itemdesc', 'rows' => '5', 'cols' => '80', 'value' => set_value('itemdesc') ) )?>
</p>
<p>
        <label for="bp">Buying price <span class="required">*</span></label>
        <?php echo form_error('bp'); ?>
        <input id="bp" type="text" name="bp"  value="<?php if(isset($id)) echo $customer[0]['bp']; else echo set_value('bp'); ?>"  />
</p>

<p>
        <label for="sp">Selling price <span class="required">*</span></label>
        <?php echo form_error('sp'); ?>
        <input id="sp" type="text" name="sp"  value="<?php if(isset($id)) echo $customer[0]['sp']; else echo set_value('sp'); ?>"  />
</p>
...
<?php if(isset($id))
 echo form_dropdown('category', $options, $customer[0]['category'],'class="form-control" title="Item category" ');
 else
  echo form_dropdown('category', $options, set_value('category'),'class="form-control" title="Item category" ')?>
...
<?php if(isset($id))  
echo form_dropdown('vat', $options, $customer[0]['vat'],'class="form-control" title="VAT" ');
 else   echo form_dropdown('vat', $options, set_value('vat'),'class="form-control" title="VAT" ')?>
</p>

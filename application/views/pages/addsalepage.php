...
echo form_open('Sale', $attributes); ?>
...
<label for="amountgiven" style="width:30%; float:left;">Amount given</label>
      ...
      <input id="amountgiven" type="text" name="amountgiven"  value="<?php echo set_value('amountgiven'); ?>" onkeyup="getMyBalance();" onkeydown="return restrictCharact(this, event,0);" style="width:30%; float:left;" />
...
function allowUs()
{
	if((Number(document.getElementById("netTotal").value)<0 || Number(document.getElementById("balance").value)<0) && document.getElementById("process").value!="INVOICE")
	{
...
function getMyBalance()
{
	...
	document.getElementById("balance").value=(amt-tot-vat);

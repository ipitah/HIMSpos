...
<thead>
<tr><td>Category</td><td>Date added</td><td>Update</td><td>Delete</td></tr>
</thead>
<tbody>
</tbody>
</table>

<button type="button" onclick="printJS('category-table', 'html')" class='btn btn-small btn-success form-control'>
    Print categories 
 </button>

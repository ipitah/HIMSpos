...
$data = array('title' => $page,  "mess" => "<p class='alert alert-danger'> Kindly fix the following errors and submit again</p>");
		...
		else // passed validation proceed to post success logic
		{
			...
			if ($this->Customer_model->UpdateCustomer($this->input->post("cid"),$form_data) == TRUE) // the information has therefore been successfully saved in the db
			{
				$page="Update Customer details";

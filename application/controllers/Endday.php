<?php
	 define('FPDF_FONTPATH',APPPATH .'plugins/font/');
	  ...
	  // require('/application/plugins/diag.php');
...
//require_once('/application/plugins/diag.php'); 

class Endday extends CI_Controller {
	...
	$result= $this->Sale_model->endofdaysales();
	...
	//	$pdf->Cell(8,5,$r->discount,1,0,'C',$fill);
		...
		if( $result= $this->Sale_model->endofdayComputation())
		{
...
//////////////////////End Sales begin stock		
	...
	$result= $this->Sale_model->endofdaystock();
	...
	//	$pdf->Cell(20,5,$r->stranscno,1,0,'C',$fill);
		...
		if( $result= $this->Sale_model->endofdayComputation2())
		{
			$dicount=0;
			 foreach($result->result() as $r) {
				$dicount+=$r->discount; 

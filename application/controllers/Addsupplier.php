...
$data = array('title' => $page,  "mess" => "<p class='alert alert-danger'> Kindly fix the following errors and submit again</p>");
		 ...
		 $this->load->view("pages/addsupplier");	
		...
		else // passed validation proceed to post success logic
		{
			...
			if ($this->Supplier_model->SaveForm($form_data) == TRUE) // the information has therefore been successfully saved in the db
			{
				$page="Add Supplier";
						  
$data = array('title' => $page,"mess" => "<p class='alert alert-success'> Your have successfully added a supplier</p>");
...
$data = array('title' => $page, "mess" => "<p class='alert alert-danger'> Error: When saving your supplier details.</p>");

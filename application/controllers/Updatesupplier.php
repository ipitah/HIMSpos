...
class Updatesupplier extends CI_Controller {
	...
	{			
		...
		$this->form_validation->set_rules('cdesc', 'Supplier description', '');			
...
$data = array('title' => $page,  "mess" => "<p class='alert alert-danger'> Kindly fix the following errors and submit again</p>");
		...
		else // passed validation proceed to post success logic
		{
			...
			if ($this->Supplier_model->UpdateSupplier($this->input->post("cid"),$form_data) == TRUE) // the information has therefore been successfully saved in the db
			{
				$page="Update Supplier details";
						  
$data = array('title' => $page,"mess" => "<p class='alert alert-success'> Your have successfully updated the customer's details</p>");
...
$data = array('title' => $page, "mess" => "<p class='alert alert-danger'> Error: When updating your customer details.</p>");
